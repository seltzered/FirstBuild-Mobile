...
-(void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if  (
         ...
         [segue.destinationViewController isKindOfClass:[FSTCookingMethodSubSelectionViewController class]] || [segue.destinationViewController isKindOfClass:[FSTRecipeViewController class]]
        )
    {
